...
public class ChangeMode implements ICommand {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) {
        if(args.length <= 1) {
            sender.sendMessage(new TextComponentString("Mode needs one of these arguments: line, circle, cube."));
            return;
        }
    ...
    public String toString() {
        return "/bl mode <ModeType> [0|1|2|3|t|m|a|f]\n- Available ModeTypes: circle, line, cube\n" +
                ...
                BlockLinesCommands.addSpaces("") + "0: A circle will be drawn.\n" +
                ...
                BlockLinesCommands.addSpaces("") + "f: A filled circle will be drawn.\n" +
